        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2 animate-fade-in">
            <div className="relative">
              ...
              <img 
                src="https://images.unsplash.com/photo-1623029439010-4c78bf86071d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" 
                alt="Armazenamento de grãos" 
          ...
          <div className="lg:w-1/2">
            ...
            <a 
              href="#contact" 
              className="bg-black hover:bg-neutral-800 text-green-500 px-6 py-3 rounded-md transition-all flex items-center justify-center gap-2 font-medium inline-flex animate-fade-in" 
